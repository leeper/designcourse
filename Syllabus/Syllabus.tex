...
Every week will involve a lecture (\textbf{Friday 11:00--12:00 in 32L.LG.03 (lower-ground level)}), followed by a class with the Graduate Teaching Assistant. 
...
Theory Evaluation & Problem Set 6 & Tuesday Feb.~7 \\
Literature Review & Formative Essay & Tuesday Feb.~21 \\ 
...
% 1
\lecture{Introduction (Sep.~30)}{An overview of the course and an introduction to political science research. How do we identify research topics to study empirically? What makes for a good political science research questions?}
...
% 5
\lecture{Translating Texts into Interpretations and Numbers (Oct.~28)}{Primary and secondary source documents provide a written record of politically relevant events and processes. Texts can be used in a number of ways in political science research. How do we draw meaning from texts in qualitative and quantitative ways? How does textual information become useful data for making political inferences?}
...
% 8
\lecture{Case Studies (Nov.~25)}{Case studies are in-depth examinations of a single manifestation of a political phenomenon and are one of the most common methods of inquiry in political science. What can we do with case studies? How do they help us to understand politics?}
