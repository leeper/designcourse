...
\frametitle{Principles of causality\footnote{From Kellstedt and Whitten}}
...
\frame{
	\frametitle{Preview}
	\begin{itemize}
	\item Next week: Ethics
		\begin{itemize}
		\item Scenarios Handout
		\end{itemize}
	\item Problem Set 6 is marked
	\item Will mark Problem Set 7 this week
	\item Problem Set 8 is due \textit{after} Research Design Proposal
	\end{itemize}
}
