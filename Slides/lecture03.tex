...
\item<2-> Recall the definition of \textit{variable}:
	\begin{itemize}
	\item A dimension that describes an observation
	\item<3-> The operationalization of a concept
	\end{itemize}
\end{itemize}
...
Once we have an operationalization, \textit{coding} turns observations of attributes into \textbf{data set observations} (DSOs)
...
\item<2-> Examples
	...
	\end{itemize}
\item<3-> \textit{Qualitative analysis} is more general and fluidic
\end{itemize}
