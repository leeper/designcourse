...
\item<2-> We rarely observe all population units
\item<3-> A ``sample'' is a set of units we actually observe
\item<4-> Sometimes we aim to \textit{generalize} from the sample to the population
\end{itemize}
...
\frame{
	...
	\begin{itemize}\itemsep0.5em
		...
		\item<4-> Quota sampling (pre-1940s, post-2000s)
...
\begin{tikzpicture}
    ...
    \fill<4->[blue,opacity=0.75] (2.5,1) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (1.8,-1) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (0,1.25) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (0,.5) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (0,-2) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (1/8,2) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (1,.75) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<4->[blue,opacity=0.75] (2,-2) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
    \fill<5->[red,opacity=0.75] (4,-1) circle (1cm) 
        node[text=white, align=center, text width=3cm] {Sample};
\end{tikzpicture}
\end{center}
\end{frame}
...
\frame{
	...
	\begin{equation}
	Pr(y=1) = \frac{1}{n}\sum_{i=1}^{n}y_i
	\end{equation}
	where $y_i = $ value for a unit, and\\
	$n = $ sample size
...
\frame<1>[label=moe]{
	...
	\item Standard MoE is twice the SE (x1.96)
...
\begin{itemize}\itemsep1em
\item Various ways to select cases
\item Various notions of representativeness
\item Case selection is one way of addressing questions of ``external validity'' but there are others, too
\end{itemize}
