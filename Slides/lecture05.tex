...
\begin{itemize}\itemsep0.5em
\item Rational choice is a deductive approach
...
\item You can build theory deductively by starting from other premises
\end{itemize}

}

% the first calculus of voting (Downs) was purely deductive
...
\begin{itemize}\itemsep0.5em
\item A wholly different alternative is to reason inductively % bottom-up appraoch
