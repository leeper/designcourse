...
\frame{
	...
	\begin{itemize}\itemsep1em
    	\item We want to observe population \textit{parameter} $\beta$
    	\item If we obtain a representative sample of population units:\\
    		\begin{itemize}\itemsep1em
        		\item Our sample statistic $\hat{\beta}$ is an unbiased estimate of $\beta$
        		\item Our sampling procedure dictates how uncertain we are about the value of $\beta$
    		\end{itemize}
	\end{itemize}
}
...
\item<4-> Kellstedt and Whitten cover more in-depth mathematical requirements
